...
var settings_scene = preload("res://modules/ui/settings.tscn")
...
func _on_create_button_pressed():
	...
	if name_input and name_input.text.strip_edges() != "":
		...
		call_deferred("_safe_change_scene", "res://modules/environment/vivarium.tscn")
	else:
...
func _safe_change_scene(scene_path: String):
	...
	print("MainMenu: Changing to scene: " + scene_path)
	
	# Create a loading indicator before switching scenes
	var loading_label = Label.new()
	loading_label.text = "Loading Vivarium..."
	loading_label.add_theme_font_size_override("font_size", 32)
	...
	# Give the UI a moment to update before changing scenes
...
func _load_vivarium(vivarium_name):
	print("MainMenu: Loading vivarium: " + vivarium_name)
	...
	# Go to the vivarium scene - use safe scene change
	call_deferred("_safe_change_scene", "res://modules/environment/vivarium.tscn")
#endregion
